...
@section('body')
    <div class="container mx-auto p-6 relative">
        <div class="flex justify-between items-center mb-4">
            <div>
                <h2 class="text-3xl font-bold text-biru4"><span class="font-bold text-biru1">Detail</span> Data Inflasi</h2>
        ...
        <div class="bg-white shadow-md rounded-xl p-4 z-10">
            <div class="flex items-center gap-2 px-4 py-1 bg-gray-100 rounded-xl mb-4 w-fit">
                ...
                <form method="GET" action="{{ route('daftar-tabel-inflasi.show', $upload->id) }}" class="flex items-center">
                    <input type="text" name="search" placeholder="Cari kelompok pengeluaran..." value="{{ $search }}"
                    ...
                    <tbody>
                        @forelse ($details as $index => $detail)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <span class="font-medium">{{ $detail->nama_kom }}</span>
                                </td>
