<div id="sidebarComponent" class="flex flex-col w-64 h-screen p-5 transition-all duration-300 bg-white text-biru1">
    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="flex items-center gap-3">
            ...
            <p id="dashboardText" class="text-xl font-bold leading-none transition-all duration-300 text-biru1 menu-text">
        ...
        <ul class="space-y-3">
            ...
            <li class="relative">
                <a id="dropdownToggleManajemenAkun" class="flex items-center justify-between w-full gap-3 px-2 py-2 rounded-lg hover:bg-biru4 hover:text-white group">
                    <div class="flex items-center">
                        <img src="{{ asset('images/sidebar/bmanakunIcon.svg') }}" alt="Ikon Dashboard Inflasi" class="w-6 h-6 icon" data-hover="{{ asset('images/sidebar/pmanakunIcon.svg') }}" data-default="{{ asset('images/sidebar/bmanakunIcon.svg') }}">
                ...
                <ul id="dropdownMenuManajemenAkun" class="hidden mt-2 ml-4 space-y-2 bg-white border-l-2 border-biru5">
                    <li><a href="{{ route('manajemen-akun.index') }}" class="flex items-center px-2 py-2 ml-8 font-normal text-[15px] hover:bg-biru5 rounded-lg menu-text" data-page="manajemen-akun">Tabel Manajemen Akun</a></li>
                    <li><a href="{{ route('master-satker.index') }}" class="flex items-center px-2 py-2 ml-8 font-normal text-[15px] hover:bg-biru5 rounded-lg menu-text" data-page="manajemen-satker">Master Satker</a></li>
                </ul>
            </li>
            @endif
            <li class="relative">
                <a id="dropdownToggleManajemenData" class="flex items-center justify-between w-full gap-3 px-2 py-2 rounded-lg hover:bg-biru4 hover:text-white group">
                    <div class="flex items-center">
                        <img src="{{ asset('images/sidebar/bmandataIcon.svg') }}" alt="Ikon Dashboard Inflasi" class="w-6 h-6 icon" data-hover="{{ asset('images/sidebar/pmandataIcon.svg') }}" data-default="{{ asset('images/sidebar/bmandataIcon.svg') }}">
                ...
                <ul id="dropdownMenuManajemenData" class="hidden mt-2 ml-4 space-y-2 bg-white border-l-2 border-biru5">
                    @if(Auth::user()->id_role == 2)
                        <li><a href="{{ route('manajemen-data-inflasi.index') }}" class="flex items-center px-2 py-2 ml-8 font-normal text-[15px] hover:bg-biru5 rounded-lg menu-text" data-page="manajemen-data-inflasi.index">Tabel Manajemen Data Inflasi</a></li>
                    @else
                        <li><a href="{{ route('manajemen-data-inflasi.index') }}" class="flex items-center px-2 py-2 ml-8 font-normal text-[15px] hover:bg-biru5 rounded-lg menu-text" data-page="manajemen-data-inflasi.index">Tabel Manajemen Data Inflasi</a></li>
                        <li><a href="{{ route('master-komoditas.index') }}" class="flex items-center px-2 py-2 ml-8 font-normal text-[15px] hover:bg-biru5 rounded-lg menu-text" data-page="master-komoditas.index">Master Komoditas</a></li>
                        <li><a href="{{ route('komoditas-utama.index') }}" class="flex items-center px-2 py-2 ml-8 font-normal text-[15px] hover:bg-biru5 rounded-lg menu-text" data-page="komoditas-utama.index">Master Komoditas Utama</a></li>
                    @endif
                </ul>
            </li>
            @endauth
            ...
            @guest
            <li>
                <a href="{{ route('daftar-tabel-inflasi.index') }}" class="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-biru4 hover:text-white group" data-page="tabel">
                    <img src="{{ asset('images/sidebar/bdataInflasiIcon.svg') }}" alt="Ikon Data Inflasi" class="w-6 h-6 icon" data-hover="{{ asset('images/sidebar/pdataInflasiIcon.svg') }}" data-default="{{ asset('images/sidebar/bdataInflasiIcon.svg') }}">
        ...
        <ul>
            <li>
                <div class="flex items-center gap-3 px-2 py-2 rounded-lg group">
                    <img src="{{ asset('images/sidebar/buserIcon.svg') }}" alt="Profil Ikon" class="w-6 h-6 icon" data-hover="{{ asset('images/sidebar/puserIcon.svg') }}" data-default="{{ asset('images/sidebar/buserIcon.svg') }}">
            ...
            <li>
                <form action="{{ route('logout') }}" method="POST" class="mt-2">
                    @csrf
                    <button type="submit" class="flex items-center w-full gap-3 px-2 py-2 rounded-lg bg-biru4 hover:bg-biru1 hover:text-white group">
                        <img src="{{ asset('images/sidebar/blogoutIcon.svg') }}" alt="Logout Ikon" class="w-6 h-6 icon logout-icon" data-hover="{{ asset('images/sidebar/plogoutIcon.svg') }}" data-default="{{ asset('images/sidebar/blogoutIcon.svg') }}">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function highlightActiveMenu() {
            document.querySelectorAll("[data-page]").forEach(item => {
                ...
                if (currentPath.includes(page) || (link && currentPath.includes(new URL(link, window.location.origin).pathname))) {
                    ...
                    if (parentMenu && parentMenu.classList.contains("hidden")) {
                        ...
                        const parentToggle = parentMenu.previousElementSibling.querySelector(".dropdown-arrow");
