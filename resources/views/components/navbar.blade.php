        ...
        <div class="flex items-center space-x-6">
            <ul class="flex items-center space-x-6 text-biru1 font-semibold">
                ...
                <li class="relative group">
                    ...
                    <ul class="absolute left-0 p-2 mt-2 w-64 font-[450] text-sm bg-white shadow-lg rounded-b-lg hidden"
                        id="dashboardMenu">
                        <li><a href="#submenu1"
                                class="block px-4 py-2 rounded-lg hover:bg-biru4 hover:text-white">Dashboard
                        ...
                        <li><a href="#submenu4"
                                class="block px-4 py-2 rounded-lg hover:bg-biru4 hover:text-white">Dashboard Series
                                Inflasi</a></li>
                    </ul>
                </li>
