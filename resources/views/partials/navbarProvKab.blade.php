        ...
        <div class="flex items-center space-x-10">
            <ul class="flex items-center space-x-6 text-biru1 font-semibold">
                ...
                <li class="relative group">
                    ...
                    <ul class="absolute left-0 mt-2 w-52 font-normal bg-white shadow-lg rounded-lg hidden" id="dropdownMenu">
                        <li><a href="#submenu1" class="block px-4 py-2 hover:bg-biru4 hover:text-white">Manajemen Akun</a></li>
                        <li><a href="#submenu2" class="block px-4 py-2 hover:bg-biru4 hover:text-white">Manajemen Data Inflasi</a></li>
                        <li><a href="#submenu3" class="block px-4 py-2 hover:bg-biru4 hover:text-white">Dashboard Data Inflasi</a></li>
                    </ul>
                </li>
            </ul>
...
<style>
    ...
    #dashboardMenu:not(.hidden) #dashboardArrow {
        fill: #0077b6; /* Warna panah saat di-hover atau dropdown terbuka */
    }
</style>
