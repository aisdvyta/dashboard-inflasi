...
@section('body')
    ...
    <div id="main1" class="relative min-h-screen flex items-center justify-center bg-cover bg-center"
        style="background-image: url('{{ asset('images/backLandingPage.svg') }}');">

        <!-- Konten -->
        <div
            class="relative rounded-[3rem] p-8 max-w-3xl mx-auto flex flex-col items-center text-center bg-white bg-opacity-70 shadow-xl backdrop-blur-md md:p-10 md:items-start md:text-left">
            ...
            <p class="text-gray-700 text-lg mt-3">
                <span class="font-semibold text-biru2">Dashboard Inflasi</span> menyajikan data inflasi terkini di wilayah
                Provinsi Jawa Timur melalui visualisasi yang interaktif dan informatif.
            </p>
            <a href="#"
                class="inline-flex items-center rounded-2xl gap-2 mt-6 px-6 py-1 bg-biru4 text-white font-semibold rounded-lg hover:bg-biru1">
    ...
    <div id="main3" class="min-h-[93vh]">
        ...
        <div class="container mx-auto px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center mt-8">
            ...
            <div class="w-full md:w-1/3 flex flex-col items-center -translate-y-8">
                <img src="{{ asset('images/pakZulKartun.svg') }}" alt="Kepala BPS Provinsi Jawa Timur"
    ...
    <div id="main4" class="bg-white py-16 px-5 min-h-[93vh]">
        <div class="max-w-7xl mx-auto h-fit bg-gray-100 rounded-3xl shadow-lg p-8 relative">
            ...
            <div class="absolute bottom-10 right-10">
                <img src="{{ asset('images/batikKawung2.svg') }}" alt="Batik Right"
            ...
            <div class="grid grid-cols-3 gap-8 mx-60 mt-10 mb-5 ">
                ...
                <div class="h-[13rem] w-[12rem] bg-white p-4 rounded-3xl shadow-lg text-center overflow-hidden">
                    ...
                    <a href="https://www.instagram.com/bpsjatim?igsh=MWE1cHA1NG9rdWhpbg==" target="_blank"
                        class="text-biru4 text-sm font-normal hover:underline">Lihat Profil →</a>
                ...
                <div class="h-[13rem] w-[12rem] bg-white p-4 rounded-3xl shadow-lg text-center overflow-hidden">
                    ...
                    <div class="mt-4 flex space-x-0 items-center justify-center">
                        ...
                        <img src="{{ asset('images/kontFBMid.svg') }}"
                ...
                <div class="h-[13rem] w-[12rem] bg-white p-4 rounded-3xl shadow-lg text-center overflow-hidden">
                    ...
                    <div class="mt-4 flex space-x-0 items-center justify-center">
                        ...
                        <img src="{{ asset('images/kontYtKanan.svg') }}"
